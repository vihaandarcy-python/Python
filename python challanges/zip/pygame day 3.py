...
background_image = pygame.transform.scale(pygame.image.load("Brawlog.png"), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
sprite1 = Sprite(pygame.Color('black'), 50, 75)
...
sprite2 = Sprite(pygame.Color('red'), 50, 75)
